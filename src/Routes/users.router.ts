...
import { uploadAvatars, uploadSkins } from "../Middlewares/multer.middleware";
...
usersRouter.put('/change-skin',uploadSkins.single('skin'), usersController.changeSkin)
usersRouter.put('/change-avatar',uploadAvatars.single('avatar'), usersController.changeAvatar)
